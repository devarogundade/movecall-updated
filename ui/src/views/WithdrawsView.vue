    ...
    <section>
        <div class="app_width">
            <div class="withdraws">
                ...
                <div class="withdraws_wrapper">
                    <div class="toolbar">
                        <input type="text" placeholder="Search">

                        <div class="tabs">
                            <button class="tab tab_active">All</button>
                            <button class="tab">Completed only</button>
                        </div>
                    </div>
                            ...
                            <tr>
                                <td>
                                    <div class="withdraw_info">
                                        <img :src="'/images/iota.png'" alt="withdraw">
                                        <p>{{ 'IOTA' }}</p>
                                    </div>
                                </td>
                                <td>0</td>
