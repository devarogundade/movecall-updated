...
module movecall::rewards_module {
    use iota::clock;
    ...
    use movecall::strategy_module::{Strategy};
    ...
    // Public functions
    public entry fun create_service_rewards_submission<CoinType>(
        ...
        let rewards_root = calc_rewards_root<CoinType>(&rewards_submission, service);
    ...
    fun calc_rewards_root<CoinType>(
        ...
        vector::append(&mut root, bcs::to_bytes<address>(&service));
        root
    }
