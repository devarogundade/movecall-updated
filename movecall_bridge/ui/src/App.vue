  ...
  <section>
    <div class="app_width">
      <div class="app">
          ...
          <div class="scroll">
            <div class="container">
              ...
              <div class="input input_disabled">
                <label>To</label>
                <div class="chain">
                  <img src="/images/iota.png" alt="IOTA">
                  <p>IOTA</p>
                  <ChevronDownIcon />
                </div>
              </div>
              ...
              <div class="input2">
                <label>Receiver (IOTA address)</label>
        ...
        <div class="about">
          <span>About</span>
          <h1>MoveCallBridge</h1>
          <p>
            MoveCallBridge is a decentralized bridge that allows users to transfer assets between different blockchains
            using
            zero-knowledge proofs.
          </p>
          <a href="https://movecall-app.netlify.app/service/0x15ebec4c1f58e38024783d351f69ccdcebf02561e5d85aaf9ac40145770a0fc4"
            target="_blank">
